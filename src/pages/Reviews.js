                    ...
                    <article className="reviews-container">
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home1.jpg")}/></div>
                            </div>
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home2.jpg")}/></div>
                            </div>
                            <div className="review-body">
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home3.jpg")}/></div>
                            </div>
                            <div className="review-body">
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home4.jpg")}/></div>
                            </div>
                            <div className="review-body">
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home5.jpg")}/></div>
                            </div>
                            <div className="review-body">
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home6.jpeg")}/></div>
                            </div>
                            <div className="review-body">
                        ...
                        <div className="review-box">
                            <div className="review-header">
                                ...
                                <div className="imagesHome"><img className="h-images" src={require("../images/home7.jpg")}/></div>
                            </div>
                            <div className="review-body">
